...
categorias.forEach((categoria) => {
    categoria.addEventListener('click', (e) => {
        ...
        // activacion del contenedor preguntas
...
preguntas.forEach((pregunta) => {
    pregunta.addEventListener('click', (e) => {
        ...
        const respuestas = pregunta.querySelector('.respuestas');
        const alturaRealRespuesta = respuestas.scrollHeight;


        console.log(respuestas.style.maxheight)
        if (!respuestas.style.maxHeight) {
            respuestas.style.maxHeight = alturaRealRespuesta + 'px';
        } else {
            respuestas.style.maxHeight = null;
        }

        preguntas.forEach((elemento) => {
            if (pregunta !== elemento) {
                elemento.classList.remove('activa');
                elemento.querySelector('.respuestas').style.maxHeight = null;
            }
        })
    })
})